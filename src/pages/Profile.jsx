  ...
  return (
    <div className="max-w-6xl mx-auto p-4 sm:p-6 lg:p-8">
      <div className="mb-6">
        ...
        <p className="text-gray-400 mt-2">Manage your profile and view your contributions</p>
      </div>
        ...
        <div className="lg:col-span-1">
          ...
          >
            <div className="flex flex-col items-center text-center">
              <div className="w-24 h-24 bg-gradient-to-br from-purple-500 to-blue-500 rounded-2xl flex items-center justify-center mb-4">
                <span className="text-3xl font-bold text-white">
                  {publicKey?.toString().slice(0, 2)}
                </span>
              </div>
              <div className="mt-4 w-full">
                <div className="flex items-center justify-center gap-2 bg-gray-800/50 rounded-xl p-3 hover:bg-gray-800/70 transition-colors">
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xl font-bold text-white">{balance ? `${balance.toFixed(2)}` : '0.00 SOL'}</p>
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            >
              ...
              <div className="mt-2 flex items-center gap-2">
                <span className="text-sm text-gray-400">Total campaigns initiated</span>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative group w-6 h-6">
                ...
                <p className="text-3xl font-bold text-white">{ balance ? `${balance.toFixed(2)}` : '0.00' }</p>               
              </div>
              <div className="mt-2 flex items-center gap-2">
                <span className="text-sm text-gray-400">Across all campaigns</span>
              </div>
            </motion.div>
          </div>
